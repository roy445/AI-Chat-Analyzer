...
type StoredPayload = { report?: AnalysisReport; ai?: AiAnalysis | null; mode?: "full" | "recap" | "achievements" };
...
export default async function SharedReportPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <ShareReportView report={payload.report} ai={payload.ai} mode={payload.mode ?? "full"} />;
}
